...
def make_bezier():
    m = new_matrix()
    m[0][0],m[1][0],m[2][0],m[3][0],m[0][1],m[1][1],m[1][2],m[0][2],m[2][1],m[0][3] = -1,3,-3,1,3,-6,3,-3,3,1
    return m

def make_hermite():
    m = new_matrix()
    m[0][0],m[1][0],m[2][0],m[3][0],m[0][1],m[1][1],m[2][1],m[3][1],m[2][2],m[0][3] = 2,-2,1,1,-3,3,-2,-1,1,1
    return m
